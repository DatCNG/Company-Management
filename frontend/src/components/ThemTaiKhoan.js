    ...
    >
      ...
      >
        ...
        <form className="form themct-form">
          ...
          <div className="form-gr">
            <div className="form-gr-content">
              <label className="label">Chọn role:</label>
              <div
                className="role-options"
              >
                <label>
                  <input type="radio" name="role" value="quanly" className="radio" /> Quản lý
                </label>
                <label>
                  <input type="radio" name="role" value="nhanvien" className="radio" /> Nhân viên
                </label>
              </div>
            </div>
          </div>
