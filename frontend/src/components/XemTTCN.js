...
const XemTTCN = () => {
  ...
  const renderModalContent = () => {
    switch (modalType) {
      case "view-da":
        return <XemDuAn onClose={closeModal} />;
      case "view-cv":
              ...
              <table className="quanly-table">
                ...
                <tbody className="quanly-tbody qlct-tbody" ref={tbodyRef}>
                  <tr>
                    ...
                    <td>
                      <button className="button-xem quanly-button-xem" onClick={() => openModal('view-da')}>
                        <FaRegEye />
                      </button>
                    </td>
                  </tr>
              ...
              <table className="quanly-table">
                ...
                <tbody className="quanly-tbody qlct-tbody" ref={tbodyRef}>
                  <tr>
                    ...
                    <td>Đang hoàn thành</td>
                    <td>
                      <button className="button-xem quanly-button-xem" onClick={() => openModal('view-cv')}>
                        <FaRegEye />
                      </button>
                    </td>
                  </tr>
