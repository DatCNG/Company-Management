...
const QLNhanVien = () => {
    ...
    return (
        <div className="quanly-container qlct-container">
            <div className='quanly-title qlct-title'>
                <h2><IoIosPeople style={{ marginRight: "0.3rem" }} />Quản Lý Nhân Viên</h2>
            </div>
            ...
            <div className='quanly-header qlct-header'>
                <div className='quanly-header-title qlct-header-title'>
                    <h3>Tổng số nhân viên:<h3>10</h3></h3>
                </div>
                <div className='quanly-them qlct-them'>
                    <button className='button-them' onClick={openAdd}>Thêm nhân viên</button>
                </div>
            </div>
